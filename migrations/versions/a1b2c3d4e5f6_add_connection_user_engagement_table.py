...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['connection_id'], ['connections.id'], name='fk_cue_connection_id', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='fk_cue_user_id', ondelete='CASCADE'),
